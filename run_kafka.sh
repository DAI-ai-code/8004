...
jps
kafka-topics.sh --zookeeper 127.0.0.1:2181 --topic tips_topic --delete
echo "-----Kafka topic tips_topic deleted-----"
kafka-topics.sh --create --zookeeper 127.0.0.1:2181 --replication-factor 1 --partitions 1 --topic tips_topic
kafka-topics.sh --zookeeper 127.0.0.1:2181 --list
echo "-----Kafka topic tips_topic created-----"
